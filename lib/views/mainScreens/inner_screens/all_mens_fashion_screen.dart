...
import 'package:angkor_shop/controllers/provider/mens_wear_provider.dart';
...
class AllMensFashionScreen extends ConsumerStatefulWidget {
  const AllMensFashionScreen({super.key});

  @override
  ConsumerState<AllMensFashionScreen> createState() =>
      _AllMensFashionScreenState();
}

class _AllMensFashionScreenState extends ConsumerState<AllMensFashionScreen> {
  ...
  Widget build(BuildContext context) {
    final menProducts = ref.watch(meansWearsProvider);
