...
import 'package:angkor_shop/views/mainScreens/widgets/count_down_widget.dart';
...
class RecentProductWidget extends ConsumerWidget {
  const RecentProductWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          SizedBox(height: 20, child: _buildTitleBar()),
          ...
          products.isEmpty
              ? Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [for (var i = 0; i < 2; i++) _buildShimmerCard()],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              : Column(
                children: List.generate(
                  (products.length >= 8 ? 4 : (products.length / 2).ceil()),
                  (rowIndex) {
