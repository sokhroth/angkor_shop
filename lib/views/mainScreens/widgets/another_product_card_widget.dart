...
import '../../../controllers/provider/currentProductProvider.dart';
import '../../mainScreens/inner_screens/product_detail_screen.dart';

class AnotherProductCardWidget extends ConsumerWidget {
  final Product product;

  const AnotherProductCardWidget({super.key, required this.product});
